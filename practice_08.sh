...
do
    ...
    #step 1.1 count raw read after qc
    #seqkit stat output/$fl/qc.fq > output/$fl/stat_qc.txt
    ...
    #./program/samtools-1.9/samtools depth output/$fl/aln.bam > output/$fl/depth_$fl.txt
    ...
    Rscript ./Test.R output/$fl/sample_qc.vcf ref/annotation_file.txt output/$fl/sample_report.csv $fl
